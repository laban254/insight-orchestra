...
class MySQLConnector(BaseConnector):
    ...
    def connect(self, connection_string: str) -> None:
        ...
        # urlparse does not percent-decode the userinfo component, so a
        # password containing '@', ':' or '/' — encoded by any tool that
        # builds this URL correctly — would otherwise reach pymysql still
        # percent-escaped and fail to authenticate.
