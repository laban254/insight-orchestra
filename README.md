...
1. **🛠️ Data Janitor**: More than just cleaning; it infers schemas, imputes missing values using statistical modes, and proactively flags data biases (e.g., high missingness in critical columns).
