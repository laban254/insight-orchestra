...
- **🔐 100% Privacy**: Run everything locally using Ollama. Your data never leaves your infrastructure.
- **🔍 Full Transparency**: Every Python command generated by the AI is available for review before execution.
- **🛠️ Flexible Connectivity**: Native support for DuckDB, PostgreSQL, MySQL, SQLite, and CSV files.
...
3. **⚖️ Debate Manager**: Acts as a quality filter, scoring hypotheses based on statistical confidence and business impact to ensure only the most valuable insights are pursued.
